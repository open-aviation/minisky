...
class Command:
    ...
    def addcommand(cls, func, parent=None, name="", **kwargs):
        ...
        target = parent.subcmds if isinstance(parent, CommandGroup) else Command.cmddict
        ...
        if self.valid:
            ...
            if self.annotations:
                ...
                if (
                    ...
                    raise IndexError(
                        f"More annotations given than function "
...
class CommandGroup(Command):
    ...
    def __init__(self, func, parent=None, name="", **kwargs):
        ...
        func.subcommand = lambda fun=None, **kwargs: command(fun, parent=self, **kwargs)
    ...
    def helptext(self, subcmd=""):
        ...
        if subcmd:
            ...
            return (
                obj.helptext()
                if obj
                else f"{subcmd} is not a subcommand of {self.name}"
            )
