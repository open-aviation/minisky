...
from clearsky.stack import commandgroup
from clearsky.stack.simstack import merge, process
...
class Importer(Entity):
    ...
    def __init_subclass__(cls):
        ...
        Importer.importcmd.subcommand(
            cls._instance._load_and_process, name=cls._instance.filetype.upper()
        )
