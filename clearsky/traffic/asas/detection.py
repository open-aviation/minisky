...
class ConflictDetection(Entity, replaceable=True):
    ...
    def __init__(self):
        ...
        self.rpz_def = cs.settings.asas_pzr * nm
        self.global_rpz = True
        # [m] Vertical separation minimum for detection
        self.hpz_def = cs.settings.asas_pzh * ft
        self.global_hpz = True
        # [s] lookahead time
        self.dtlookahead_def = cs.settings.asas_dtlookahead
    ...
    def clearconfdb(self):
        ...
        self.tcpa = np.array([])
        self.tLOS = np.array([])
        self.inconf = np.zeros(cs.traf.ntraf)
        self.tcpamax = np.zeros(cs.traf.ntraf)
    ...
    def detect(self, ownship, intruder, rpz, hpz, dtlookahead):
        ...
        clearsky.traffic.asas.statebased.
        """
        confpairs = []
        lospairs = []
