...
from clearsky.core.replaceable import Replaceable
from clearsky.core.simtime import timed_function
from clearsky.core.trafficarrays import TrafficArrays
        ...
        if cls._proxy is None:
            if cls._instance is None:
                ...
                for name, cmd in cls._stackcmds.items():
                    cmd.callback = getattr(cls._instance, name, cmd.notimplemented)
