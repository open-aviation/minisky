...
from clearsky.tools.aero import nm
from clearsky.tools.misc import findall
...
class Navdatabase:
    ...
    def reset(self):
        ...
        self.aptelev = aptdata[
            "apelev"
        ]  # field elevation in meters [m] above mean sea level
    ...
    def defwpt(self, name=None, lat=None, lon=None, wptype=None):
        ...
        # No data: give info on waypoint
            ...
            reflat, reflon = cs.scr.getviewctr()
        ...
        # Update screen info
        cs.scr.addnavwpt(name.upper(), lat, lon)
    ...
    def delwpt(self, name=None):
        ...
        cs.scr.removenavwpt(name.upper())
