...
Per-aircraft state and the subsystems that update it each timestep: autopilot/FMS,
routes, conflict detection and resolution, aircraft performance, wind, and turbulence.

## Traffic

::: minisky.traffic.traffic.Traffic
