...
The script initialises the simulator with the scenario, applies the optional [config](configuration.md), loads configured plugins, and runs the [`Runner`][minisky.Runner] loop until the
