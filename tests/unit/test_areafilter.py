...
class TestBox:
    def test_inside_and_outside(self, area_filter):
    ...
    def test_altitude_bounds(self, area_filter):
    ...
    def test_array_input(self, area_filter):
        area_filter.define_area("B", "BOX", [52.0, 4.0, 53.0, 5.0])
...
class TestCircle:
    def test_center_inside_far_point_outside(self, area_filter):
...
class TestPoly:
    def test_triangle_centroid_inside(self, area_filter):
