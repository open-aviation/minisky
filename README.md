...
- builds on top of BlueSky's mature and proven foundations: `.scn` scenario files, the core traffic/navigation model, OpenAP performance models, and conflict detection/resolution algorithms
