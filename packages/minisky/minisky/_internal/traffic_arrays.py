...
from minisky._internal.identifiers import normalize_public_name
...
class VariantArray(Generic[ArrayValueT]):
    ...
    !!! note
        ...
        [traffic arrays][minisky.TrafficArrays] by default zero-fills new
...
class OptionalArray(Generic[ArrayValueT]):
    """Vectorised `T | None`. See [minisky.VariantArray][]."""
